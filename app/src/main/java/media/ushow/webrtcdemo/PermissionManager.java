...
/**
 * Created by alankong on 2018/1/26.
 */
...
public class PermissionManager {
    ...
    public void requestPermissions(final Context activity, String[] permissions, final int requestCode, final Listener listener) {
    ...
    //为了兼容国内手机，需要二次检查
    private void checkPermissions(final Context activity, List<String> permissions, final int requestCode, Listener listener) {
    ...
    //永久拒绝，打开设置
    public void showAlwaysDeniedDialog(final Context activity, List<String> permissions) {
    ...
    //非永久拒绝，重新申请
    private void showRationaleDialog(final Context activity, List<String> permissions, final RequestExecutor executor) {
        new AlertDialog.Builder(activity)
                .setMessage("您拒绝了" + getDescription(permissions) + "权限，此功能需要授权才可以使用")
